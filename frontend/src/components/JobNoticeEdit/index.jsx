...
import { updateJobNotice } from '../../app/actions/jobnotice.actions';

function JobNoticeEdit(props) {
  const dispatch = useDispatch();
  const selectedNotice = useSelector((state) => state.jobnotice.selectedNotice);
  ...
  const handleOnSubmit = () => {
    ...
    dispatch(updateJobNotice(dataObject));
